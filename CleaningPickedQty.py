import os
import pandas as pd
data = pd.read_excel(r'C:\Users\user\Desktop\Picked qty\Musanze_Cyuve raw data.xlsx')
dir = r'C:\Users\user\Desktop\Picked qty'

splitInputs = data.Inputs.str.split(" ",n=5,expand=True)
